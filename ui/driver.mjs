...
const COMMANDS = {
  ...
  // Re-acquire the renderer page after a reload/crash detached the handle.
  async reattach() {
    if (!app) return console.log('ERROR: launch first');
    page = app.windows().find(w => !w.url().startsWith('devtools://'));
    if (!page) return console.log('no window found');
    COMMANDS.attach();
    console.log('reattached:', page.url());
  },
...
console.log('Tuttle driver — "help" for commands, "launch" to start');
rl.prompt();

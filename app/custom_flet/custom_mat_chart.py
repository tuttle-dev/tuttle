...
try:
    ...
    raise Exception(
        'Install "matplotlib" Python package to use CustomMatplotlibChart control.'
    )


class CustomMatplotlibChart(Container):
    """Customized matplotlib chart to make it transparent"""

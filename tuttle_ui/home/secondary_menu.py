...
class SecondaryMenuHandler:
    ...
    def get_menu_item_lbl(self, item: SecondaryMenuItems) -> str:
        """returns a label given a secondary menu item"""
        return INVOICE

    def get_menu_item_icon(self, item: SecondaryMenuItems) -> str:
        """returns the un-selected-state-icon given a menu item"""
        return icons.ATTACH_MONEY_OUTLINED

    def get_menu_item_selected_icon(self, item: SecondaryMenuItems) -> str:
        """returns the selected-state-icon given a menu item"""
        return icons.ATTACH_MONEY_ROUNDED

    def get_menu_item_from_index(self, index: int) -> SecondaryMenuItems:
        """Given an integer index, returns the corresponding side menu item"""
        return SecondaryMenuItems.INVOICE

    def get_menu_destination_view_for_item(self, menu_item):
        """Given a sidemenu item, returns the corresponding view"""
        return Container()

    def get_create_route_or_intent(self, menu_item: SecondaryMenuItems):

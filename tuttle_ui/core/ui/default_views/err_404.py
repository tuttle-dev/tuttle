...
class Error404Screen(TuttleView, UserControl):
    ...
    def __init__(self, changeRouteCallback: Callable[[str, typing.Optional[any]], None]):
        super().__init__(hasFloatingActionBtn=False, hasAppBar=False, onChangeRouteCallback=changeRouteCallback)

...
from core.ui.utils.flet_constants import (TXT_ALIGN_CENTER, CENTER_ALIGNMENT,
                                          START_ALIGNMENT)
...
splashSection = Container(
                        ...
                        content=Column(
                            ...
                            controls=[
                                ...
                                headlines.get_headline_with_subtitle(strings.APP_NAME, strings.APP_DESCRIPTION, alignmentInContainer=CENTER_ALIGNMENT, txtAlignment=TXT_ALIGN_CENTER, titleSize=headline3Size, subtitleSize=headline4Size),
                            ]
                        )
                        )
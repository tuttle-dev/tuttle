"""add fixed_price to contract, make rate nullable

Revision ID: 574b8329a133
Revises: fbfa8c0c36e4
Create Date: 2026-06-26 10:18:25.924404
...
revision: str = "574b8329a133"
down_revision: Union[str, Sequence[str], None] = "fbfa8c0c36e4"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("contract", schema=None) as batch_op:
        batch_op.add_column(sa.Column("fixed_price", sa.Numeric(precision=12, scale=2), nullable=True))
        batch_op.alter_column("rate", existing_type=sa.NUMERIC(), nullable=True)
...
def downgrade() -> None:
    ...
    1. Delete this revision file (versions/574b8329a133_*.py)

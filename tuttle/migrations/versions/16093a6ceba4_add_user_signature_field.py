...
Revision ID: 16093a6ceba4
Revises: c3d70beffa72
Create Date: 2026-07-09 22:00:33.796108
...
revision: str = "16093a6ceba4"
down_revision: Union[str, Sequence[str], None] = "c3d70beffa72"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("user", schema=None) as batch_op:
        batch_op.add_column(sa.Column("signature", sqlmodel.sql.sqltypes.AutoString(), nullable=True))
...
def downgrade() -> None:
    ...
    1. Delete this revision file (versions/16093a6ceba4_*.py)

"""add user logo column

Revision ID: 82849a169a70
Revises: 04a4df6c20c8
Create Date: 2026-06-11 12:15:38.901047
...
revision: str = "82849a169a70"
down_revision: Union[str, Sequence[str], None] = "04a4df6c20c8"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("user", schema=None) as batch_op:
        batch_op.add_column(sa.Column("logo", sqlmodel.sql.sqltypes.AutoString(), nullable=True))
...
def downgrade() -> None:
    ...
    1. Delete this revision file (versions/82849a169a70_*.py)

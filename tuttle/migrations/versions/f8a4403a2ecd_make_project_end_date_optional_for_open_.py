"""make project end_date optional for open-ended projects

Revision ID: f8a4403a2ecd
Revises: 8de1ce679065
Create Date: 2026-07-08 09:25:59.263408
...
revision: str = "f8a4403a2ecd"
down_revision: Union[str, Sequence[str], None] = "8de1ce679065"
...
def downgrade() -> None:
    ...
    1. Delete this revision file (versions/f8a4403a2ecd_*.py)
